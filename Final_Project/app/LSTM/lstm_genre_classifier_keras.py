...
print("Training ...")
model.fit(genre_features.train_X, genre_features.train_Y, batch_size=batch_size, epochs=nb_epochs, shuffle=True)
...
print("\nPredicting ...")
prediction = model.predict(genre_features.test_X, batch_size=batch_size,verbose=1)
